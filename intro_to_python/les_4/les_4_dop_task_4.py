...
menu = {
    ...
    4: 'выберите - 4, чтобы добавить нового друга',
...
template = {'Имя нового друга': ('новые предметы', str)}  # шаблон для нового друга
...
# Функция наполнения множества вещей в зависимости от вопроса question
...
while True:
    ...
    question = input('Выберите номер вопроса или 0 для выхода: ')
    print()
