...
Урожайность черничных кустов представлена в виде списка
arr, где arr[i] - это урожайность (количество ягод) i-го куста.
...
for idx, i in enumerate(arr):
    if i == arr[0]:
        total_data.append(i + arr[-1] + arr[1])
    elif i == arr[-1]:
        total_data.append(i + arr[-2] + arr[0])
