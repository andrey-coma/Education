...
first_team = [round(uniform(5, 10), 2) for f_item in range(1, 20)]
second_team = [round(uniform(5, 10), 2) for s_item in range(1, 20)]
tour_winners = [round((first_team[i] + second_team[i]), 2) for i in range(len(first_team))]
